...
contract Flipper {
    ...
    function joinGame() public payable {
        ...
        require(payable(msg.sender) != player1 && payable(msg.sender) != player2, "You cannot sit on both sides of the table.");
        require(player1 == address(0) || player2 == address(0), "You cannot sit on both sides of the table.");
    ...
    function terminateGame() public {
        require(
            (msg.sender == player1 && player2 == address(0)) ||
