...
contract Flipper {
    ...
    bool public payer1_is_first_seated;
    ...
    function getWinner() public {
        ...
        uint256 x = uint256(blockhash(lastBlock));
        if (x == 0) {
            if (payer1_is_first_seated) {
